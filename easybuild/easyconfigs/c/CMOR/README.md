...
-   Trivial port of the 3.7.2 EasyConfig, though according to the release notes
    several bugs have been fixed.


### Version 3.8.0 for CPE 24.03
...
-   Almost trivial port of the 3.8.0 EasyConfig for 24.03, but:
    ...
    -   The `sed` command to inject a version number was not needed.
