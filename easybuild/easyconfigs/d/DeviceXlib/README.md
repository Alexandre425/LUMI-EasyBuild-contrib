# DeviceXLib technical information

-   [deviceXlib on GitLab](https://gitlab.com/max-centre/components/devicexlib)

    -   [tags for download](https://gitlab.com/max-centre/components/devicexlib/-/tags)
