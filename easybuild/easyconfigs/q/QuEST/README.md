...
For version 4, the installation procedure has much improved and we can 
follow the standard CMake process again, though we do need to do some
corrections afterwards to help EasyBuild automatically detect the binaries,
etc.
